...
export default function QuickContactSection() {
  const handleCall = () => {
    window.location.href = "tel:03123359106";
  };
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Get in touch with Dr. Yumna Nasir's clinic right away
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            {/* <div className="bg-card rounded-2xl p-6 shadow-lg border border-border hover:shadow-xl transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Immediate phone consultation available
              </p>
              <Button
                onClick={handleCall}
            ...
            <div className="bg-card rounded-2xl p-6 shadow-lg border border-border hover:shadow-xl transition-shadow">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-muted-foreground">2:00 PM - 5:30 PM</span>
                </div>
              </div>
            </div>
          </div>
